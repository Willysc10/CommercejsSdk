// src/lib.rs
/*
 * Core library for CommercejsSdk
 */
...
#[derive(Debug)]
pub struct CommercejsSdkProcessor {
    verbose: bool,
    processed_count: usize,
}

impl CommercejsSdkProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting CommercejsSdk processing");
    
    let mut processor = CommercejsSdkProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = CommercejsSdkProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = CommercejsSdkProcessor::new(false);
